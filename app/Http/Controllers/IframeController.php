...
class IframeController extends Controller
{
    ...
    public static  function sanitizeAndValidateUrl()
    {
     ...
     */
    public static function fetch_content($url) {
        $ch = curl_init();
     ...
     */
    public static function rewrite_urls($content, $base_url) {
         ...
         */
    public static function rewrite_js_content($content, $base_url) {
    ...
    public static function startHere($url="http://google.com") {
        // Determine content type and apply necessary transformations
        $parsed_url = parse_url($url);
        $base_url = $parsed_url['scheme'] . '://' . $parsed_url['host'];
        $response = IframeController::fetch_content($url);
