...
<div class="wrapper">
  <div class="description">
    <h1>Your List Joe Top Email Ads</h1>
    <div class="par">
      Welcome to your Top Email advertising page.
      These ads are only available for as long as you are upgraded,
      and they are automatically added to 1000s of random emails every day at List Joe,
      so that they always go to fresh leads.
    </div>
    <div class="par">
      You can add and edit your Top Email Ad here:
    </div>
  </div>
  ...
  <div class="topmemberad_add">
    <div class="sidebar_vda">
      ...
      <div class="text">
        <div class="title" id="title">{{ $topEmailAd->headline }}</div>
        <div class="desc1" id="desc1">{{ $topEmailAd->body1 }}</div>
        <div class="desc2" id="desc2">{{ $topEmailAd->body2 }}</div>
      </div>
      <div class="url">
        <a href="#" id="url"> {{ $topEmailAd->url }}</a>
      </div>
...
<!-- <div class="topmemberad_add"> -->
    <div class="buttons">
      ...
      <div> Displayed Since: {{ $topEmailAd->created_at }}</div>
      <div><b> 
       Views {{ $topEmailAd->views }}
       Clicks {{ $topEmailAd->clicks }}
     </b></div>
   </div>
...
<form class="spotlight_form"  method="post">
  ...
  <form class="spotlight_form"  style="display: none" method="post">
    ...
    <div class="line">
      ...
      @if(isset($topEmailAd))
      <input type="text" name="title" maxlength="20" value="{{$topEmailAd->headline }}" placeholder="20 characters maximum"/>
      @else
    ...
    <div class="line">
      ...
      @if(isset($topEmailAd))
      <input type="text" name="desc1" maxlength="35" value="{{ $topEmailAd->body1 }}" placeholder="35 characters maximum"/>
      @else
    ...
    <div class="line">
      ...
      @if(isset($topEmailAd))
      <input type="text" name="desc2" maxlength="35" value="{{ $topEmailAd->body2 }}" placeholder="35 characters maximum"/>
      @else
    ...
    <div class="line">
      ...
      @if(isset($topEmailAd))
      <input type="text" name="url" maxlength="75" value="{{ $topEmailAd->url }}" placeholder="http://yourwebsite.com"/>
      @else
...
<form class="spotlight_form"  method="post">
  ...
  <div class="line">
    <div class="name">Description Line 1</div>
    <input type="text" name="desc1" maxlength="50" value="" placeholder="50 characters maximum"/>
  </div>
  <div class="line">
    <div class="name">Description Line 2</div>
    <input type="text" name="desc2" maxlength="50" value="" placeholder="50 characters maximum"/>
  </div>
  <div class="line">
    <div class="name">URL of website</div>
    <input type="text" name="url" maxlength="75" value="" placeholder="http://yourwebsite.com"/>
