...
<div class="wrapper">
  ...
  <div class="upgrade_page">
    ...
    you. </div> <div class="price_table"> <table> <tr>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td class="price" style="width: 190px;">$37</td> <td> <button
        style="background-color:#6772E5;color:#FFF;padding:8px
        12px;border:0;border-radius:4px;font-size:1em"
        id="checkout-button-plan_FORHHz8Z4y4mxB" role="link"
        onclick="buy('FORHHz8Z4y4mxB')" > Buy Now </button> </td> </tr> <tr>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          <td class="price" style="width: 190px;">$47</td> <td> <button
            style="background-color:#6772E5;color:#FFF;padding:8px
            12px;border:0;border-radius:4px;font-size:1em"
            id="checkout-button-plan_FORIh7fPcR3jk3" role="link"
            onclick="buy('FORIh7fPcR3jk3')" > Buy Now </button> </td> </tr> <tr>
              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              <td class="price" style="width: 190px;">$67</td> <td> <button
                style="background-color:#6772E5;color:#FFF;padding:8px
                12px;border:0;border-radius:4px;font-size:1em"
                id="checkout-button-plan_FORKF7IdkMapem" role="link"
                onclick="buy('FORKF7IdkMapem')" > Buy Now </button> </td> </tr> <tr>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td class="price" style="width: 190px;">$197</td> <td> <button
                    style="background-color:#6772E5;color:#FFF;padding:8px
                    12px;border:0;border-radius:4px;font-size:1em"
                    id="checkout-button-plan_FORh3ErttGddzW" role="link"
                    onclick="buy('FORh3ErttGddzW')" > Buy Now </button> </td> </tr> <tr>
                      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                      <td class="price" style="width: 190px;">$397</td> <td> <button
                        style="background-color:#6772E5;color:#FFF;padding:8px
                        12px;border:0;border-radius:4px;font-size:1em"
                        id="checkout-button-plan_FORjPNggavUhbW" role="link"
                        onclick="buy('FORjPNggavUhbW')" > Buy Now </button> </td> </tr> </table> </div>
                                                ...
                                                <td class="price" style="width: 190px;">$37</td> <td> <button
                                                  ...
                                                  onclick="buy('FORHHz8Z4y4mxB')" >Buy Now</button> </td> </tr> <tr>
                                                    ...
                                                    {{-- <td class="price" style="width: 190px;">$47</td> <td> <button
                                                      ...
                                                      12px;border:0;border-radius:4px;font-size:1em"
                                                      id="checkout-button-plan_FORIh7fPcR3jk3" role="link"
                                                      onclick="buy('FORIh7fPcR3jk3')" > Buy Now </button> </a></td> </tr> <tr>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> --}}
                                                        <td class="price" style="width: 190px;">$47</td> <td> <button
                                                          style="background-color:#6772E5;color:#FFF;padding:8px
                                                          12px;border:0;border-radius:4px;font-size:1em"
                                                          id="checkout-button-plan_FY3H1kzb2LxdBR" role="link"
                                                          onclick="buy('FY3H1kzb2LxdBR')" > Buy Now </button> </td> </tr> <tr>
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                            <td class="price" style="width: 190px;">$67</td> <td> <button
                                                              style="background-color:#6772E5;color:#FFF;padding:8px
                                                              12px;border:0;border-radius:4px;font-size:1em"
                                                                ...
                                                                <td class="price" style="width: 190px;">$197</td> <td> <button
                                                                  ...
                                                                  onclick="buy('FORh3ErttGddzW')" > Buy Now </button> </td> </tr> <tr>
                                                                    ...
                                                                    <td class="price" style="width: 190px;">$397</td> <td> <button
                                                                      ...
                                                                      12px;border:0;border-radius:4px;font-size:1em"
                                                                      id="checkout-button-plan_FORjPNggavUhbW" role="link"
                                                                      onclick="buy('FORjPNggavUhbW')" > Buy Now </button> </td> </tr> </table>
