		...
		*/
		...
		DecoupledEditor.create(document.querySelector('#editor'), {
			...
			ckbox: {
				...
				tokenUrl: 'https://123480.cke-cs.com/token/dev/casB5Jh1GdbnR2MMG9QgEnpmrGBiENzmZbCj?limit=10'
			},
			cloudServices: {
				// Be careful - do not use the development token endpoint on production systems!
				tokenUrl: 'https://123480.cke-cs.com/token/dev/casB5Jh1GdbnR2MMG9QgEnpmrGBiENzmZbCj?limit=10',
				webSocketUrl: 'wss://123480.cke-cs.com/ws',
				uploadUrl: 'https://123480.cke-cs.com/easyimage/upload/'
			},
			collaboration: {
			...
			licenseKey: 'c1RDVVIwTHVyOWVtbTAydmY1MW1SNlJqK2lYczRpanorb1ZkcndCUGVvdnpLcEpVbmI0TU9BSmFsc0FkREE9PS1NakF5TkRFeU1Uaz0=',
			link: {
