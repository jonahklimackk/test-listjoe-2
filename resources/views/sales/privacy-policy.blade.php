<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
            <html>
            <head><script src="/q-Lenox-So-res-And-Found-most-not-shee-be-Pitful" async></script>
...
body .blankLine {display:block; border-bottom:solid 1px black;}body ol,body ul{margin-left:0;padding-left:0}body .header,body .footer,body .firstHeader,body .firstFooter,body .printWatermark{display:none}body li{padding-left:25px;margin-left:15px}body #outputPage,body .documentContent,body .contract{padding:2em;overflow-wrap:break-word;word-wrap:break-word;word-break:break-word;overflow-x:hidden}body .outputVersion2 li.lhl{display:block}body .outputVersion2 ol ol{list-style:lower-alpha}body .outputVersion2 ol ol ol{list-style:lower-roman}body .outputVersion2 li>div{display:table;margin:0 !important;padding:0 !important}.LD body #contractbody li,.LD body .contractbody li{padding-left:25px;margin-left:30px}body .outputVersion1:not(.templated) *,body .outputVersion2:not(.templated) *{font-family:"Times New Roman",serif;font-size:12pt;line-height:18pt}body .outputVersion1:not(.templated) * ul,body .outputVersion2:not(.templated) * ul{list-style:disc}body .outputVersion1:not(.templated) * .lh,body .outputVersion1:not(.templated) * .lhl,body .outputVersion2:not(.templated) * .lh,body .outputVersion2:not(.templated) * .lhl{list-style:none}body .outputVersion1:not(.templated) * strong,body .outputVersion2:not(.templated) * strong{font-weight:700}
	...
	<p style="text-align:center;" class="documentTitle"><strong>www.listjoe.com Privacy Policy</strong>
	</p>
	<p style="text-align:center;">Type of website: Ecommerce<br>Effective date: 13th day of December, 2024
	</p>
	<p style="text-align:left;">www.listjoe.com (the "Site") is owned and operated by Jonah Klimaack. Jonah Klimaack is the data controller and can be contacted at: <br><br>jonahklimackk@gmail.com<br>(343) 262-9621<br>139 Balsam Street South
	</p>
	...
	<p style="text-align:left;">When the legal basis for us processing your personal data is that you have provided your consent to that processing, you may withdraw your consent at any time. If you withdraw your consent, it will not make processing which we completed before you withdrew your consent unlawful.
	</p>
	<p style="text-align:left;">You can withdraw your consent by: _____________________________________________________________________________
	</p></div><div>
	...
	<ol start="1">
		<li value="1"><span>Users have provided their consent to the processing of their data for one or more specific purposes;</span><br>
		</li>
		<li value="2"><span>Processing of user personal data is necessary for us or a third pary to pursue a legitimate interest. Our legitimate interest is not overriden by the interests or fundamenal rights and freedoms of users. Our legitimate interest(s) are: <span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span>;</span><br>
		</li>
		<li value="3"><span>Processing of user personal data is necessary for us to take, at the request of a user, steps before entering a contract or for the performance of a contract to which a user is a party. If a user does not provide the the personal data necessary to perform a contract the consequences are as follows: <span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span>;</span><br>
		</li>
		<li value="4"><span>Processing of user personal data is necessary for us to comply with a legal obligation. If a user does not provide the the personal data necessary for us to perform a legal obligation the consequences are as follows: <span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span>; and</span><br>
		</li>
		<li value="5"><span>Processing of user personal data is necessary to a task carried out in the public interest or in the exercise of our official authority.</span><br>
		</li>
	</ol></div>
	...
	<ol start="1">
		<li value="1"><span>First and last name; and</span><br>
		</li>
	...
	<ol start="1">
		<li value="1"><span>Creating an account.</span><br>
		</li>
	</ol>
	<p style="text-align:left;"><strong><u>How We Use Personal Data</u></strong><br>Data collected on our Site will only be used for the purposes specified in this Privacy Policy or indicated on the relevant pages of our Site. We will not use your data beyond what we disclose in this Privacy Policy.
	</p>
	...
	<ol start="1">
		<li value="1"><span>Facilitate use of website.</span><br>
		</li>
	</ol>
	...
	<p style="text-align:left;"><strong><u>Contact Information</u></strong><br>If you have any questions, concerns or complaints, you can contact our privacy officer, __________, at:<br><br>________________________________________<br>________________________________________<br>________________________________________
	</p><div><br class="pageBreak">
	<p style="text-align:center;"><strong>Children's Privacy Policy</strong><strong><br></strong><strong>Website: www.listjoe.com (the "Site") </strong>
	</p>
	<p style="text-align:left;">This Children's Privacy Policy supplements the www.listjoe.com Privacy Policy and applies to the personal information of children in the United States who are under the age of thirteen (13) ("child" or "children"). This Children's Privacy Policy is made in accordance with the United States Children's Online Privacy Protection Act ("COPPA"). Any terms defined in COPPA have the same meaning when used in this Children's Privacy Policy.
	</p>
	<p style="text-align:left;"><strong><u>Children's Data We Collect</u></strong><br>We do not knowingly collect the personal information of children under the age of thirteen (13).
	</p>
	<p style="text-align:left;"><strong><u>Public Availability</u></strong><br>Children are not able to make their personal information publicly available on our Site.
	</p>
	<p style="text-align:left;"><strong><u>Third Party Operators</u></strong><br>Third parties do not use our Site to collect personal information about children who use our Site.
	</p>
	<p style="text-align:left;"><strong><u>Parental Rights</u></strong><br>A child's parent or guardian can review their child's personal information, direct us to delete their child's personal information, and refuse any further collection or use of their child's personal information. A parent or guardian can also agree to the collection and use of their child's personal information but not allow us to disclose that personal information to third parties, unless disclosure is part of the service provided by our Site. A parent or guardian can exercise these rights via the following method(s):
	</p>
	<ol start="1">
		<li value="1"><span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span><span class="blankLine">&nbsp;</span>.</span><br>
		</li>
	</ol>
	<p style="text-align:left;">We will not require a child to disclose more information than is reasonably necessary to participate in an activity on our Site.
	</p>
	<p style="text-align:left;"><strong><u>Contact Information</u></strong><br>Questions and concerns about this Children's Privacy Policy or about our collection and use of children's personal information, can be sent to:<br><br>Name: __________<br>Email: __________<br>Address: ________________________________________<br>Phone number: ________________________________________
	</p></div><div class="LDCopyright">
				<p>&copy;2002-2024 LawDepot.ca&reg;</p>
			</div>
		</div>
	</div>
            </div>
