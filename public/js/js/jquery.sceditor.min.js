(function(d){d.sceditor=function(b,c){var a=this,f=d(b),e=null,h=null,g=null,i=null,k=null,l=null,m=!1,o=[],j=null,p=null,J=[],r,q,t,B,w,x,C,D,E,F,G,y,z,H,n,A,u,v,I,s;a.commands=d.sceditor.commands;D=function(){var b=d('<div contenteditable="true">')[0].contentEditable,b="undefined"!==typeof b&&"inherit"!==b;k=d("<textarea></textarea>").hide();g=d('<iframe frameborder="0"></iframe>');"https:"===window.location.protocol&&g.attr("src","javascript:false");e.append(g).append(k);i=g[0];v(f.width());u(f.height());
b||(n().designMode="On");n().open();n().write('<html><head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" /><meta http-equiv="Content-Type" content="text/html;charset='+a.options.charset+'" /><link rel="stylesheet" type="text/css" href="'+a.options.style+'" /></head><body contenteditable="true"></body></html>');n().close();b||(n().designMode="On");d(n()).find("body").keypress(x);d(n()).keypress(x);d(n()).mousedown(C);d(n()).bind("beforedeactivate keypress",w);d(n()).focus(function(){j=
null})};E=function(){var b=function(b){B(d(this),a.commands[d(this).data("sceditor-command")]);b.preventDefault()};h=d('<div class="sceditor-toolbar" />');var c=a.options.toolbar.split("|"),f,m,g,o;for(o=0;o<c.length;o++){f=d('<div class="sceditor-group" />');m=c[o].split(",");for(var j=0;j<m.length;j++)a.commands.hasOwnProperty(m[j])&&(g=a.commands[m[j]].tooltip?a._(a.commands[m[j]].tooltip):m[j],g=d('<a class="sceditor-button sceditor-button-'+m[j]+' " unselectable="on"><div unselectable="on">'+
...
locale:"en",charset:"utf-8",emoticonsCompat:!1,emoticons:{dropdown:{":)":"http://listjoe.com/emoticons/smile.png",":angel:":"http://listjoe.com/emoticons/angel.png",":angry:":"http://listjoe.com/emoticons/angry.png","8-)":"http://listjoe.com/emoticons/cool.png",":'(":"http://listjoe.com/emoticons/cwy.png",":ermm:":"http://listjoe.com/emoticons/ermm.png",":D":"http://listjoe.com/emoticons/grin.png","<3":"http://listjoe.com/emoticons/heart.png",":(":"http://listjoe.com/emoticons/sad.png",":O":"http://listjoe.com/emoticons/shocked.png",":P":"http://listjoe.com/emoticons/tongue.png",";)":"http://listjoe.com/emoticons/wink.png"},more:{":alien:":"http://listjoe.com/emoticons/alien.png",":blink:":"http://listjoe.com/emoticons/blink.png",":blush:":"http://listjoe.com/emoticons/blush.png",
":cheerful:":"http://listjoe.com/emoticons/cheerful.png",":devil:":"http://listjoe.com/emoticons/devil.png",":dizzy:":"http://listjoe.com/emoticons/dizzy.png",":getlost:":"http://listjoe.com/emoticons/getlost.png",":happy:":"http://listjoe.com/emoticons/happy.png",":kissing:":"http://listjoe.com/emoticons/kissing.png",":ninja:":"http://listjoe.com/emoticons/ninja.png",":pinch:":"http://listjoe.com/emoticons/pinch.png",":pouty:":"http://listjoe.com/emoticons/pouty.png",":sick:":"http://listjoe.com/emoticons/sick.png",":sideways:":"http://listjoe.com/emoticons/sideways.png",":silly:":"http://listjoe.com/emoticons/silly.png",":sleeping:":"http://listjoe.com/emoticons/sleeping.png",":unsure:":"http://listjoe.com/emoticons/unsure.png",":woot:":"http://listjoe.com/emoticons/w00t.png",
":wassat:":"http://listjoe.com/emoticons/wassat.png"},hidden:{":whistling:":"http://listjoe.com/emoticons/whistling.png",":love:":"http://listjoe.com/emoticons/wub.png"}},width:null,height:null,resizeEnabled:!0,resizeMinWidth:null,resizeMinHeight:null,resizeMaxHeight:null,resizeMaxWidth:null,getHtmlHandler:null,getTextHandler:null,dateFormat:"year-month-day",toolbarContainer:null};d.fn.sceditor=function(b){return this.each(function(){new d.sceditor(this,b)})}})(jQuery);(function(d){d.sceditorBBCodePlugin=function(b,c){var a=this,f,e,h,g;a.bbcodes=d.sceditorBBCodePlugin.bbcodes;var i={},k={},l={ul:["li"],ol:["li"],table:["tr"],tr:["td","th"],code:["br","p","div"],youtube:[]};g=function(a,b){var c=d.camelCase(b),e;return"text-align"===b&&(e=d(a),e.parent().css(b)!==e.css(b)&&"block"===e.css("display")&&!e.is("hr")&&!e.is("th"))?e.css(b):a.style?a.style[c]:null};f=function(b,c,e){var f;b[0].nodeName.toLowerCase();e=!!e;if(!k[e])return c;d.each(k[e],function(e,j){f=
g(b[0],e);null==f||""===f||g(b.parent()[0],e)===f||d.each(j,function(e,g){if(null===g||-1<d.inArray(f.toString(),g))c=d.isFunction(a.bbcodes[e].format)?a.bbcodes[e].format.call(a,b,c):h(a.bbcodes[e].format,c)})});return c};e=function(b,c,e){var f=b.get(0).nodeName.toLowerCase(),e=!!e;i[f]&&i[f][e]&&d.each(i[f][e],function(e,f){if(null!==f){var g=!1;d.each(f,function(a,c){if(!(null==b.attr(a)||null!==c&&0>d.inArray(b.attr(a),c)))return g=!0,!1});if(!g)return}c=d.isFunction(a.bbcodes[e].format)?a.bbcodes[e].format.call(a,
...
a.getHtmlHandler=function(b,c){d.sceditor.dom.removeWhiteSpace(c[0]);return d.trim(a.elementToBbcode(c))};a.elementToBbcode=function(a){return function j(a,b){var c="";d.sceditor.dom.traverse(a,function(a){var g=d(a),h="",i=a.nodeName.toLowerCase(),m=l[i],k=!0;"object"===typeof b&&((k=-1<d.inArray(i,b))||(m=b));3!==a.nodeType?g.hasClass("sceditor-ignore")||("iframe"!==i&&(h=j(a,m)),k?(g.is("code")||(h=f(g,h),h=e(g,h),h=f(g,h,!0)),c+=e(g,h,!0)):c+=h):c+=a.nodeValue},!1,!0);return c}(a.get(0))};a.getTextHandler=
function(b){var c,e,f=/\[([^\[\s=]*?)(?:([^\[]*?))?\]((?:[\s\S(?!=\[\\\1)](?!\[\1))*?)\[\/(\1)\]/g,g=/(\S+)=((?:(?:(["'])(?:\\\3|[^\3])*?\3))|(?:[^'"\s]+))/g;e=function(b,c,e,f){var i={},j;if(e)if(e=d.trim(e),"="===e.charAt(0)&&1>=e.split("=").length-1||"url"===c)i.defaultAttr=a.stripQuotes(e.substr(1));else for("="===e.charAt(0)&&(e="defaultAttr"+e);j=g.exec(e);)i[j[1].toLowerCase()]=a.stripQuotes(j[2]);return!a.bbcodes[c]?b:d.isFunction(a.bbcodes[c].html)?a.bbcodes[c].html.call(a,c,i,f):h(a.bbcodes[c].html,
f)};for(b=b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\r/g,"").replace(/(\[\/?(?:left|center|right|justify)\])\n/g,"$1").replace(/([^\n\[\]]+)\n/g,"<div>$1</div>").replace(/\n/g,"<br />");b!==c;)c=b,b=b.replace(f,e);b=b.replace(/\[hr\]/gi,"<hr>");return b.replace(/ {2}(?=([^<\>]*?<|[^<\>]*?$))/g," &nbsp;")};d.data(b,"sceditorbbcode",a);a.options=d.extend({},d.sceditor.defaultOptions,c);(function(){d.each(a.bbcodes,function(b){"undefined"!==typeof a.bbcodes[b].tags&&
d.each(a.bbcodes[b].tags,function(c,d){var e=!!a.bbcodes[b].isBlock;i[c]=i[c]||{};i[c][e]=i[c][e]||{};i[c][e][b]=d});"undefined"!==typeof a.bbcodes[b].styles&&d.each(a.bbcodes[b].styles,function(c,d){var e=!!a.bbcodes[b].isBlock;k[e]=k[e]||{};k[e][c]=k[e][c]||{};k[e][c][b]=d})})})();new d.sceditor(b,d.extend({},a.options,{getHtmlHandler:a.getHtmlHandler,getTextHandler:a.getTextHandler}))};d.sceditorBBCodePlugin.bbcodes={b:{tags:{b:null,strong:null},styles:{"font-weight":"bold,bolder,401,700,800,900".split(",")},
